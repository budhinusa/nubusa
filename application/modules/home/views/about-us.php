        ...
        <div class="container">
            ...
            <div class="row row-wrap" data-gutter="60">
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="AMaze" />
                        </header>
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="Chiara" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="Bubbles" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="Gamer Chick" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="Afro" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="Me with the Uke" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="Andrea" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="<?php print base_url()."files/crm/website/depan1/".rand(1,12).".jpg"?>" alt="Image Alternative text" title="Spidy" />
                        </header>
                        <div class="thumb-caption">
                            <h5 class="thumb-title">Oliver Ross</h5>
                            <p class="thumb-meta text-small">Office Manager</p>
