...
<div class="row">
  <div class="col-md-6">
    <div class="box box-success box-solid">
      <div class="box-header with-border">
        <h3 class="box-title"><?php print lang("Satuan")?></h3>
        <div class="box-tools pull-right">
          <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        </div>
      </div>
      <?php print $this->global_format->html_grid($grid_satuan)?>
    </div>
  </div>
  <div class="col-md-6" id="form-satuan">
    <div class="box box-warning box-solid">
      <div class="box-header with-border">
        <h3 class="box-title"><?php print lang("Form")?></h3>
        <div class="box-tools pull-right">
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-xs-6">
              ...
              <?php 
              print $this->form_eksternal->form_input('', "", 'v-model="level" class="form-control input-sm" placeholder="'.lang("Level").'"');
              ?>
            </div>
            <div class="col-xs-6">
              <label><?php print lang("Nilai")?></label>
              <?php 
              print $this->form_eksternal->form_input('', "", 'v-model="nilai" class="form-control input-sm" placeholder="'.lang("Nilai").'"');
              ?>
            </div>
          </div>
        </div>
