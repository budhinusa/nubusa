<div class="row">
  ...
  <div class="col-md-6" id="form-credit" style="display: none;">
    <div class="box box-warning box-solid" id="form-utama">
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-xs-12">
              <label><?php print lang("Credit")?></label>
              <input type="number" v-model="credit" class="form-control input-sm" />
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12">
...
<div class="row">
  <div class="col-md-12" id="list-log-credit" style="display: none;">
