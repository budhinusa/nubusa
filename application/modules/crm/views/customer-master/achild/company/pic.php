  ...
  <div class="col-md-12">
    <div class="box box-info box-solid">
      <div class="box-header with-border">
        <h3 class="box-title"><?php print lang("List PIC"); ?></h3>
        <div class="box-tools pull-right">
          <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
        </div>
      </div>
      <?php print $this->global_format->html_grid($grid_pic)?>
    </div>
  </div>
  <div class="col-md-12">
    <div class="box box-warning box-solid" id="form-pic">
      <div class="box-header with-border">
        ...
        <?php if($this->session->userdata("id") == 1){ ?>    
          <div class="row">
            <div class="col-xs-12">
              ...
              <select2 :options="options_users" v-model="id_users" id="pic-users" class="form-control input-sm">
              </select2>
            </div>
          </div>
        <?php } ?>    
          <div class="row">
            <div class="col-xs-3">
              ...
              <select2 :options="options_title" v-model="title" id="pic-title" class="form-control input-sm">
              </select2>
            </div>
            <div class="col-xs-5">
