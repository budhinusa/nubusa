        ...
        <div class="form-group">
          <div class="row">
            <div class="col-xs-12">
              ...
              <select2 :options="options_status" v-model="id_users" class="form-control input-sm">
              </select2>
            </div>
          </div>
					<div class="row">
            <div class="col-xs-12">
              <label><?php print lang("Store")?></label>
              <select2 :options="options_store" v-model="id_crm_agent_store" class="form-control input-sm">
              </select2>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12">
              ...
              print $this->form_eksternal->form_dropdown('title', $title, array(), 'v-model="title" class="form-control input-sm"');
              ?>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-12">
              ...
              <?php 
              print $this->form_eksternal->form_input('jabatan', "", 'v-model="jabatan" class="form-control input-sm" placeholder="'.lang("Position").'"');
              ?>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <?php 
              print $this->form_eksternal->form_input('no', "", 'v-model="no" class="form-control input-sm" placeholder="'.lang("Number").'"');
              ?>
            </div>
          </div>
          <div class="row">
