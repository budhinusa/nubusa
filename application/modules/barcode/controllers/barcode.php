...
class Barcode extends MX_Controller {
  ...
  /*
	 ...
	 *	  
	 *  Date:	05/25/2003
	 *  code type : code128, code128a, code39, code25, codebar
	 *  Usage:	<img src="/barcode.php?text=testing" alt="testing" />
	 */
	public function index( $text="ANTAVAYA", $size="20", $orientation="horizontal", $code_type="code128", $print=false, $filepath="" ) {
		$code_string = "";
