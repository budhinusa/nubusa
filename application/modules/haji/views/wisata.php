...
<section>
		<div class="rows inner_banner">
				<div class="container">
						<h2><span>Product Wisata</span></h2><ul><li><a href="#inner-page-title">Home</a></li><li><i class="fa fa-angle-right" aria-hidden="true"></i> </li><li><a href="#inner-page-title" class="bread-acti">Umroh</a></li></ul>
				</div>
		</div>
</section>
<!--====== PLACES ==========-->
		...
		<div class="rows inn-page-bg com-colo">
				<div class="container inn-page-con-bg tb-space pad-bot-redu-5" id="inner-page-title">
						...
						<div class="spe-title col-md-12">
								<h2>TOP <span>Product Wisata</span></h2>
