        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open_multipart("", 'role="form"', 
              ...
              <div class="box-body">
                ...
                <div class="control-group">
                  <label>Harga</label>
                    <?php print $this->form_eksternal->form_input("harga", $detail[0]->harga, 'class="form-control" placeholder="Harga"');?>
                </div>
                ...
                <div class="control-group">
                  <label>Promo</label>
                    <?php print $this->form_eksternal->form_dropdown('promo', array('1' => "Available", '2' => "Promo"), array($detail[0]->promo), 'class="form-control input-sm"')?>
                </div>
                ...
                <div class="control-group">
                  ...
                  <?php print $this->form_eksternal->form_upload('file_promo', $detail[0]->file_promo, "class='form-control input-sm'");
                  if($detail[0]->file_promo)
                    print "<br /><img src='".base_url()."files/antavaya/haji/{$detail[0]->file_promo}' width='100' />";
                  else
                    print "<br /><img src='".base_url()."files/no-pic.png' width='50' />";
                  ?>
                </div>
