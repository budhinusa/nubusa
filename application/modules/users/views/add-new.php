                ...
                <?php print $this->form_eksternal->form_open_multipart("", 'role="form"', 
                  ...
                  <div class="box-body">
                    <div class="control-group">
					  ...
					  <div class="input-group">
                        <label><?php print lang("Signature")?></label>
                        <?php 
							print $this->form_eksternal->form_upload('signature', "", "class='form-control input-sm'  @change='onGambarChange'");
						?>						
						<img src='<?php print $signature_link;?>' width='100' />
                      </div>
