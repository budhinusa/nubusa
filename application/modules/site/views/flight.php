            ...
            <div class="flight-sort-filter">
                ...
                <div class="well grey filter-sort p-0">
                    <div class="btn-group sort-by-button-group md">
                      <a href="javascript:void(0)" id="urutberangkat" class="btn btn-link"><?php print lang("BERANGKAT")?>  <span class="fa fa-unsorted"></span></a>
                      <a href="javascript:void(0)" id="uruttiba" class="btn btn-link"><?php print lang("TIBA")?>  <span class="fa fa-unsorted"></span></a>
                      <a href="javascript:void(0)" id="urutharga" class="btn btn-link">HARGA PER ORANG  <span class="fa fa-unsorted"></span></a>
                      <a href="javascript:void(0)" id="urutdurasi" class="btn btn-link"><?php print lang("DURASI")?>  <span class="fa fa-unsorted"></span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="clearfix plan-depart">
            ...
            <div class="lists">
                <ol class="undefined list-inline popup-depart-fitur">
                    ...
                    <li>
                        <div data-toggle="tooltip" data-placement="top" title="1x Pemberhentian di Surabaya">1 Transit</div>
                    </li>
                    <li>
                        <div data-toggle="tooltip" data-placement="top" title="Durasi 1 jam 30 menit">1h 30m</div>
                    </li>
                    <li>
                        <div data-toggle="tooltip" data-placement="top" title="Harga barang sudah termasuk bagasi 15KG"><span class="fa fa-suitcase"></span> 20KG</div>
                    </li>
                    <li>
                        <div data-toggle="tooltip" data-placement="top" title="Harga sudah termasuk makan"><span class="fa fa-cutlery"></span></div>
                    </li>
                    <li>
                        <div data-toggle="tooltip" data-placement="top" title="Penerbangan overnight"><span class="fa fa-moon-o"></span></div>
                    </li>
                </ol>
            </div>
            ...
            <div class="col-sm-6 col-xs-7">
                ...
                <section class="card">
                    <div class="media">
                        ...
                        <div class="media-body media-middle"><small>Harga Khusus <br /> Mega Infinite</small></div>
                    </div>
