            ...
            <div class="row">
                        <section class="col-md-8 content-left pull-md-right">
                                    ...
                                    <div class="panel-body">
                                      ...
                                      foreach ($payment_channel['data'] AS $pc){
                                        ...
                                        print "<div class='btn-group matchHeight-nowrap'>"
                                          . "<a href='".site_url("site/book-result/{$kode}/{$pc['id']}")."' class='{$active} btn item'>"
                                            . "<span>{$pc['title']}</span>"
                                          . "</a>"
                                        . "</div>";
                                      }
                                ...
                                <div id="form-diskon" class="collapse coupon-code m-t-15">
                                    <div class="form-inline" id="validasi-voucher">
                                      <div class="form-group coupon-input">
                                        <input type="text" v-model="code" placeholder="Masukan kode disini" class="form-control">
                                      </div>
                                      <div class="form-group coupon-submit m-l-15">
                                        <button type="button" v-on:click="valid" value="VALIDASI" class="btn btn-round btn-red btn-sm"><?php print lang("VALIDASI")?></button>
                                      </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-center m-t-20 p-sm-hor-15">
                                    ...
                                    <form method="POST" action="<?php print site_url("site/book-payment")?>">
                                        ...
                                        <input type="text" name="id_crm_pos_discount_voucher_use" id="crm-pos-discount-voucher-use" value="" style="display: none">
