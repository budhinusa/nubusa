          ...
          <section id="info-passenger" class="element-item info-passenger ">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4 class="panel-title"><?php print lang("Booking Gagal")?></h4>
              </div>
              <div class="panel-body">
                <p>
                  <?php print lang("Mohon maaf proses booking anda gagal.") ?><br />
                  <?php print lang("Anda dapat melakukan proses pencarian ulang.") ?><br />
                  <?php print lang("Permasalahan ini akan kami tindak lanjuti agar tidak terulang kemudian kembali.") ?><br />
                </p>
              </div>
            </div>
          </section>
