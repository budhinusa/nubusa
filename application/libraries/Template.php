...
class Template
{
  ...
  private $_heads = '';
    ...
    $template['heads'] = $this->_heads;
		...
		$this->_ci->output->set_header('Expires: Wed, 01 Jan 2014 00:00:01 GMT');
      ...
      $folde = DEFAULTTHEMES;
      if($this->_data["theme2nd"])
        $folde = $this->_data["theme2nd"];
			$this->_body =  self::_load_view('layouts/'.$folde.'/'.$this->_layout, $this->_data, TRUE, self::_find_view_folder());
		}
	...
	{
//    print $override_view_path.$view.'<br />';
  ...
  public function set_heads($view){
		$this->_heads = $view;
		return $this;
	}
}
